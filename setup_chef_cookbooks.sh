...
for cookbook in "apt 2.4.0" python build-essential ubuntu cron "chef-client 3.0.6" ntp yum logrotate yum-epel "sysctl 0.3.5" chef_handler 7-zip windows ark poise; do
  if [[ ! -d ${cookbook% *} ]]; then
